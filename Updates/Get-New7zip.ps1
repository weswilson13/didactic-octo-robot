<#
.DESCRIPTION
Script to check latest stable release of 7zip. If a newer version is available, 
...
# turn off progress bar for *this 7zip session* - this makes web request download exponentially faster
...
$downloadURI = "$releaseUri\download\$versionSegment\7z$($version.replace('.',''))-x64.exe".Replace("\","/")
