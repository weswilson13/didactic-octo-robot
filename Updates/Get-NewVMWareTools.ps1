<#
.DESCRIPTION
Script to check latest stable release of VMWare Tools. If a newer version is available, 
...
.\Get-NewVMWareTools.ps1 -Verbose
#>
...
# turn off progress bar for *this VMWare Tools session* - this makes web request download exponentially faster
