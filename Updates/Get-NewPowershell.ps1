<#
.DESCRIPTION
Script to check latest stable release of Powershell. If a newer version is available, 
...
$product = 'Powershell'
$appRepo = "Z:\WindowsPowershell\Installers"
...
$downloadURI = "$releaseUri\download\$versionSegment\Powershell-$version-win-x64.msi".Replace("\","/")
